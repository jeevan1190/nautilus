    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 md:py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full mb-8 mx-auto lg:mx-0">
            ...
            <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-display font-bold text-primary-foreground mb-8 leading-[1.1]">
              Nautilus <br />
              <span className="text-gradient-gold italic">International</span>
            </motion.h1>

            <motion.p variants={itemVariants} className="max-w-2xl mx-auto lg:mx-0 text-primary-foreground/70 text-base md:text-xl lg:text-2xl leading-relaxed mb-12 font-light">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start">
              <Link
                to="/services"
                className="gradient-teal text-accent-foreground px-8 md:px-10 py-4 md:py-5 rounded-md font-bold tracking-wider hover:shadow-[0_0_20px_rgba(190,65,40,0.4)] transition-all transform hover:-translate-y-1 text-center text-sm md:text-base"
              >
                OUR SERVICES
              </Link>
              <Link
                to="/contact"
                className="group relative overflow-hidden px-8 md:px-10 py-4 md:py-5 rounded-md font-bold tracking-wider text-primary-foreground border border-primary-foreground/30 text-center text-sm md:text-base"
              >
          ...
          >
            <div className="absolute -inset-4 bg-gold/20 rounded-[2rem] blur-2xl" />
            <motion.div
